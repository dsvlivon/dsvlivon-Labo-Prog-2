...
namespace VistaConsola
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (Equipo.ValidarEquipo(equipo)) Console.WriteLine("El equipo es válido"); else Console.WriteLine("El equipo no es válido");
            equipo.DirectorTecnico = dt; equipo = equipo + j4; equipo = equipo + j5; equipo = equipo + j6; equipo = equipo + j7; equipo = equipo + j8;
            Console.WriteLine("*******************************EQUIPO VÁLIDO*********************************"); 
            // Imprimo los datos del equipo 
            Console.WriteLine((string)equipo); if(Equipo.ValidarEquipo(equipo)) Console.WriteLine("El equipo es válido"); else Console.WriteLine("El equipo no es válido"); 
            Console.ReadKey();
            }
    }
}
